        ...
        <section style={{
                        ...
                        <Comment key={message.count}>
                            ...
                            <Comment.Content>
                                <Comment.Author style={{ display: "inline-block" }}>
                                    <a href={`/profile/${message.user.id}`} target="_blank" rel="noreferrer">
            ...
            <form style={{ display: "flex" }}
                ...
                <Input value={input}
                       ...
                       placeholder={t("pages.video.chat_input_placeholder")}></Input>
        ...
        <div style={{
            ...
            <div style={{
                ...
                { error ? (
                    ...
                    <Message header="Meeting not started"
                             content={
                    ...
                    <Message header="Meeting already finished"
                        ...
                        <div style={{
                            ...
                            <main style={{
                                ...
                                <section style={{
                                    ...
                                    <VideoContainer roomNumber={event.room_id}
