        ...
        <Page hasMenu={false}>
            ...
            { user?.educationText && (
                <Segment.Group>
                    ...
                    <Segment dangerouslySetInnerHTML={{ __html: user?.educationText ?? "" }} />
                </Segment.Group>
            ) }
            { user?.experienceText && (
                <Segment.Group>
                    ...
                    <Segment dangerouslySetInnerHTML={{ __html: user?.experienceText ?? "" }} />
                </Segment.Group>
            ) }
            { user?.specialtyText && (
                <Segment.Group>
                    ...
                    <Segment dangerouslySetInnerHTML={{ __html: user?.specialtyText ?? "" }} />
                </Segment.Group>
            ) }
